...
val friends = listOf(
    ...
    UserProfileData(R.drawable.ava2, "Tony", "冬至", gender = "女", uid = "1000"),
    UserProfileData(R.drawable.ava3, "Meth", "“做最好的准备  也做最坏的打算”",gender = "女", uid = "1002"),
    UserProfileData(R.drawable.ava4, "Beatriz", "水母只能在深海度过相对失败的一生",gender = "女", uid = "1003"),
    UserProfileData(R.drawable.ava5, "香辣鸡腿堡", "请向前走，不要在此停留。konpaku.cn",gender = "女", uid = "1004"),
    UserProfileData(R.drawable.ava6, "爱丽丝", "逝者如斯夫，不舍昼夜", uid = "1005"),
    UserProfileData(R.drawable.ava7, "Horizon", "对韭当割，人生几何。", uid = "1008",gender = "男"),
    UserProfileData(R.drawable.ava8, "鲤鱼", "未曾谋面的也终将会相遇的，慢慢来吧，慢慢约会吧\uD83D\uDC31",gender = "男", uid = "1006"),
    ...
    UserProfileData(R.drawable.ava4, "Nini", "水母只能在深海度过相对失败的一生",gender = "女"),
    ...
    UserProfileData(R.drawable.ava8, "泰拉瑞亚", "未曾谋面的也终将会相遇的，慢慢来吧，慢慢约会吧\uD83D\uDC31", uid = "1007"),
    ...
    UserProfileData(R.drawable.ava10, "0x5f3759df", "科学的尽头是玄学",gender = "男")
)
